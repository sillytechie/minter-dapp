const contractAddress = "0x119fbB6b4bA1C9725A213199166dB41DC9807C32"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Renegade Witches NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Renegade Witches NFT Project is a blockchain project that aims to create a safe and valuable space for enlightened humans and healers to connect, share and heal. We are working to develop our own conscious ecosystem with this project where consumers can access an abudance of healing materials, professionals and other content as well, contributing healers can earn an income based on their contributions.';
